...
class PostgresqlFields {
  ...
  static nodeModel(tableName, fields) {
    ...
    // 读取模板路径
    // let templatePath =  "..\\templates\\node.models.sequelize.template";
    const templatePath = path.join(__dirname, '..', '..', 'templates', 'node.models.sequelize.template');
  ...
  static nodeModelOnela(tableName, fields) {
    ...
    const templatePath = path.join(__dirname, '..', '..', 'templates', 'node.models.onela.template');
    // 读取模板内容
    return PostgresqlFields.getTemplate(templatePath)
      .then((templateContent) => {
        new_param.templateContent = templateContent; // 模板内容
  ...
  static denoModel(tableName, fields) {
    ...
    // 读取模板路径
    // let templatePath =  "..\\templates\\deno.models.template";
    const templatePath = path.join(__dirname, '..', '..', 'templates', 'deno.models.template');
    // 读取模板内容
    return PostgresqlFields.getTemplate(templatePath)
      .then((templateContent) => {
        new_param.templateContent = templateContent; // 模板内容
  ...
  static javaModel(tableName, fields) {
    ...
    // 读取模板路径
    // let templatePath =  "..\\templates\\java.models.template";
    const templatePath = path.join(__dirname, '..','..','templates', 'java.models.template');
    // 读取模板内容
    return PostgresqlFields.getTemplate(templatePath)
      .then((templateContent) => {
        new_param.templateContent = templateContent; // 模板内容
  ...
  static csharpModel(tableName, fields) {
    ...
    // 读取模板路径
    // let templatePath =  "..\\templates\\cshap.models.template";
    const templatePath = path.join(__dirname, '..', '..','templates', 'cshap.models.template');
    // 读取模板内容
    return PostgresqlFields.getTemplate(templatePath)
      .then((templateContent) => {
        new_param.templateContent = templateContent; // 模板内容
  ...
  static javaMapper(tableName, fields) {
    ...
    // let templatePath =  "..\\templates\\java.mapper.template";
    const templatePath = path.join(__dirname, '..', 'templates', 'java.mapper.template');
    // 读取模板内容
    return PostgresqlFields.getTemplate(templatePath)
      .then((templateContent) => {
        new_param.templateContent = templateContent; // 模板内容
  ...
  static javaDao(tableName, fields) {
    ...
    // 读取模板路径
    // let templatePath =  "..\\templates\\java.dao.template";
    const templatePath = path.join(__dirname, '..', 'templates', 'java.dao.template');
    // 读取模板内容
    return PostgresqlFields.getTemplate(templatePath)
      .then((templateContent) => {
        new_param.templateContent = templateContent; // 模板内容
