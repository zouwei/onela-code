...
class OnelaBase {
    ...
    getConfigFields(tableName) {
        ...
        var sql = `
            SELECT cc.*,d.description as column_comment
            FROM  information_schema.columns as cc, pg_description as d 
            WHERE cc.ordinal_position = d.objsubid AND table_name ='${tableName}';`;
